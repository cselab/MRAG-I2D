...
public:
  ...
  PF_AgentVector(MRAG::ArgumentParser &parser, const Real lr,
  ...
  void getTargets(vector<pair<Real, Real>> &targets,
  ...
  bool choose(const Real time,
              map<string, vector<PF_Agent *>> *collection = NULL);
  void reward(const Real time,
              map<string, vector<PF_Agent *>> *collection = NULL);
  void fitness();
  void error();
  void learn(const Real time,
             map<string, vector<PF_Agent *>> *collection = NULL,
