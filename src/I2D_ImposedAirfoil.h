...
public:
  I2D_ImposedAirfoil(Grid<W, B> &grid, ArgumentParser &parser, const Real _xm,
                     const Real _ym, const Real _D, const Real _angle,
                     const Real _vx, const Real _vy, const int d1, const int d2,
                     const int d3d4, const Real _eps, const Real Uinf[2],
