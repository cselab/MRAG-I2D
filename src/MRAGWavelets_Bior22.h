...
private:
  static Real _Kernel(Real x) { return max(0.0, 1.0 - fabs(x)); }
...
public:
  ...
  static const Real getCenteringOffset() { return 0.5; }
...
const Real Wavelets_Bior22::Ha[5] = {-0.176776695296637, 0.353553390593274,
                                     1.060660171779821, 0.353553390593274,
                                     -0.176776695296637};
const Real Wavelets_Bior22::Ga[3] = {0.353553390593274, -0.707106781186548,
                                     0.353553390593274};
const Real Wavelets_Bior22::Hs[3] = {0.353553390593274, 0.707106781186548,
                                     0.353553390593274};
const Real Wavelets_Bior22::Gs[5] = {0.176776695296637, 0.353553390593274,
                                     -1.060660171779821, 0.353553390593274,
                                     0.176776695296637};
