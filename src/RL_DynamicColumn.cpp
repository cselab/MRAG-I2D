...
RL_DynamicColumn::RL_DynamicColumn(MRAG::ArgumentParser &parser, const Real _x,
                                   const Real _y, const Real _D, const int _ID,
                                   RL_TabularPolicy **_policy)
    : x(_x), y(_y), D(_D), RL_Agent(parser, "RL_Column") {}
...
void RL_DynamicColumn::update(const Real dt, const Real t,
