...
public:
  I2D_ImposedEllipseRotation(ArgumentParser &parser, Grid<W, B> &grid,
                             const Real _xm, const Real _ym, const Real _xcrot,
                             const Real _ycrot, const Real _T, const Real _D,
                             const Real _aspectRatio, const Real eps,
                             const Real Uinf[2],
