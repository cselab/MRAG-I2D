...
public:
  ...
  QtBox(const unsigned int _maxLevel, const double _width,
        const double _minVertex[2], const int _invLevel = 0,
        QtBox *_parent = NULL, const unsigned int _idxX = 0,
        const unsigned int _idxY = 0);
  ~QtBox();
...
protected:
  ...
  void _getChildBoxDimensions(const double parentMinVertex[2],
