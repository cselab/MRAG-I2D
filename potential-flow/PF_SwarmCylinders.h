...
public:
  SwarmCylinders(int n_, double radius_, double rmin_, double A_, double K1_,
                 double K2_, double alpha_);
...
protected:
  ...
  const double
      radius; /// cylinder radius defines min distance to wall of spline
