...
inline int _computeNeighborCode(const GridNode &b, const GridNode &n) {
  ...
  const double p[3] = {dilate * (n.index[0] + 0.5) - (b.index[0] + 0.5),
  ...
  const int d[3] = {(int)(p[0] / pmax), (int)(p[1] / pmax), (int)(p[2] / pmax)};
...
void MRAG_BBInfoCreator<WaveletsType, BlockType>::_computeEasyGhosts_SameLevel(
  ...
  const int iE_bspace[3] = {std::min((n.index[0] + 1 - b.index[0]) * B::sizeX,
                                     B::sizeX + stencil_end[0] - 1),
                            std::min((n.index[1] + 1 - b.index[1]) * B::sizeY,
                                     B::sizeY + stencil_end[1] - 1),
                            std::min((n.index[2] + 1 - b.index[2]) * B::sizeZ,
                                     B::sizeZ + stencil_end[2] - 1)};

  const int iS_nspace[3] = {iS_bspace[0] + (b.index[0] - n.index[0]) * B::sizeX,
                            iS_bspace[1] + (b.index[1] - n.index[1]) * B::sizeY,
                            iS_bspace[2] +
                                (b.index[2] - n.index[2]) * B::sizeZ};

  const int iE_nspace[3] = {iE_bspace[0] + (b.index[0] - n.index[0]) * B::sizeX,
                            iE_bspace[1] + (b.index[1] - n.index[1]) * B::sizeY,
                            iE_bspace[2] +
                                (b.index[2] - n.index[2]) * B::sizeZ};

  nFoundEasyGhosts = std::max(0, (iE_bspace[0] - iS_bspace[0])) *
  ...
  // 3.
  {
    ...
    const int ghosts_end[3] = {
        dir[0] < 0 ? 0
                   : (dir[0] == 0 ? B::sizeX : (B::sizeX + stencil_end[0] - 1)),
        dir[1] < 0 ? 0
                   : (dir[1] == 0 ? B::sizeY : (B::sizeY + stencil_end[1] - 1)),
        dir[2] < 0
            ? 0
            : (dir[2] == 0 ? B::sizeZ : (B::sizeZ + stencil_end[2] - 1))};

    const int ghosts_size[3] = {ghosts_end[0] - ghosts_start[0],
...
void MRAG_BBInfoCreator<WaveletsType, BlockType>::_computeEasyGhosts_Synthesis(
  ...
  const int sReconstructable_bspace[3] = {
      B::shouldProcessDirectionX
          ? (((n.index[0] * B::sizeX - 1 + 1 - W::HsSupport[0] - 1
               << inv_level_difference) +
              W::HsSupport[0] + 1) -
             b.index[0] * B::sizeX)
          : 0,
      B::shouldProcessDirectionY
          ? (((n.index[1] * B::sizeY - 1 + 1 - W::HsSupport[0] - 1
               << inv_level_difference) +
              W::HsSupport[0] + 1) -
             b.index[1] * B::sizeY)
          : 0,
      B::shouldProcessDirectionZ
          ? (((n.index[2] * B::sizeZ - 1 + 1 - W::HsSupport[0] - 1
               << inv_level_difference) +
              W::HsSupport[0] + 1) -
             b.index[2] * B::sizeZ)
          : 0};
  ...
  const int eReconstructable_bspace[3] = {
      B::shouldProcessDirectionX
          ? (((1 + n.index[0]) * B::sizeX - W::HsSupport[1] + 1
              << inv_level_difference) +
             W::HsSupport[1] - 1 - b.index[0] * B::sizeX)
          : 1,
      B::shouldProcessDirectionY
          ? (((1 + n.index[1]) * B::sizeY - W::HsSupport[1] + 1
              << inv_level_difference) +
             W::HsSupport[1] - 1 - b.index[1] * B::sizeY)
          : 1,
      B::shouldProcessDirectionZ
          ? (((1 + n.index[2]) * B::sizeZ - W::HsSupport[1] + 1
              << inv_level_difference) +
             W::HsSupport[1] - 1 - b.index[2] * B::sizeZ)
          : 1,
  };
  ...
  nFoundEasyGhosts = std::max(0, (eEasy_bspace[0] - sEasy_bspace[0])) *
                     std::max(0, (eEasy_bspace[1] - sEasy_bspace[1])) *
                     std::max(0, (eEasy_bspace[2] - sEasy_bspace[2]));

  // 3.
  const int ncoverage_start[3] = {
      (0 + n.index[0] * B::sizeX << inv_level_difference) -
          b.index[0] * B::sizeX,
      (0 + n.index[1] * B::sizeY << inv_level_difference) -
          b.index[1] * B::sizeY,
      (0 + n.index[2] * B::sizeZ << inv_level_difference) -
          b.index[2] * B::sizeZ};

  const int ncoverage_end[3] = {
      ((1 + n.index[0]) * B::sizeX << inv_level_difference) -
          b.index[0] * B::sizeX,
      ((1 + n.index[1]) * B::sizeY << inv_level_difference) -
          b.index[1] * B::sizeY,
      ((1 + n.index[2]) * B::sizeZ << inv_level_difference) -
          b.index[2] * B::sizeZ};
  ...
  const int nb_intersec_end[3] = {std::min(ncoverage_end[0], ghosts_end[0]),
  ...
  Matrix3D<char, true, _MRAG_GHOSTSCREATION_ALLOCATOR> matNeeded(
      size_iteration_nspace[0], size_iteration_nspace[1],
      size_iteration_nspace[2]);
  Matrix3D<int, true, _MRAG_GHOSTSCREATION_ALLOCATOR> matKey(
      size_iteration_nspace[0], size_iteration_nspace[1],
      size_iteration_nspace[2]);
  Matrix3D<int, true, _MRAG_GHOSTSCREATION_ALLOCATOR> matDest(
      eEasy_bspace[0] - sEasy_bspace[0], eEasy_bspace[1] - sEasy_bspace[1],
      eEasy_bspace[2] - sEasy_bspace[2]);
  matNeeded = 0;
    ...
    for (s[2] = sIteration_nspace[2]; s[2] < eIteration_nspace[2]; s[2]++)
      for (s[1] = sIteration_nspace[1]; s[1] < eIteration_nspace[1]; s[1]++)
        for (s[0] = sIteration_nspace[0]; s[0] < eIteration_nspace[0]; s[0]++) {
          const int s_dest[3] = {
              std::max(sEasy_bspace[0],
                       (n.index[0] * B::sizeX + s[0] << inv_level_difference) +
                           filter_support[0] - b.index[0] * B::sizeX),
              std::max(sEasy_bspace[1],
                       (n.index[1] * B::sizeY + s[1] << inv_level_difference) +
                           filter_support[0] - b.index[1] * B::sizeY),
              std::max(sEasy_bspace[2],
                       (n.index[2] * B::sizeZ + s[2] << inv_level_difference) +
                           filter_support[0] - b.index[2] * B::sizeZ)};

          const int e_dest[3] = {
              std::min(eEasy_bspace[0],
                       (n.index[0] * B::sizeX + s[0] << inv_level_difference) +
                           filter_support[1] - b.index[0] * B::sizeX),
              std::min(eEasy_bspace[1],
                       (n.index[1] * B::sizeY + s[1] << inv_level_difference) +
                           filter_support[1] - b.index[1] * B::sizeY),
              std::min(eEasy_bspace[2],
                       (n.index[2] * B::sizeZ + s[2] << inv_level_difference) +
                           filter_support[1] - b.index[2] * B::sizeZ)};
          ...
          for (d[2] = s_dest[2]; d[2] < e_dest[2]; d[2]++)
            for (d[1] = s_dest[1]; d[1] < e_dest[1]; d[1]++)
              for (d[0] = s_dest[0]; d[0] < e_dest[0]; d[0]++) {
                const double w =
                    (B::shouldProcessDirectionX
                         ? weights[d[0] - s_bspace[0] - filter_support[0]]
                         : 1) *
                    (B::shouldProcessDirectionY
                         ? weights[d[1] - s_bspace[1] - filter_support[0]]
                         : 1) *
                    (B::shouldProcessDirectionZ
                         ? weights[d[2] - s_bspace[2] - filter_support[0]]
                         : 1);

                if (fabs(w) > 0) {

                  matNeeded.Access(s[0] - sIteration_nspace[0],
                                   s[1] - sIteration_nspace[1],
                                   s[2] - sIteration_nspace[2]) = 1;
                  currPointsToAdd++;
                  goto _exit_dest;
                }
              }
  ...
  // A. fill the information of the index pool
  {
    ...
    for (int i = 0; i < nElements; i++)
      if (matNeeded.LinAccess(i) == 1)
        matKey.LinAccess(i) = iStartI + counter++;
    ...
    for (int i = 0; i < nElements; i++)
      if (matNeeded.LinAccess(i) == 1) {
        ...
        const int n_index[3] = {
            ...
            (i / size_iteration_nspace[0] % size_iteration_nspace[1]) +
                sIteration_nspace[1],
            (i / size_iteration_nspace[0] / size_iteration_nspace[1] %
             size_iteration_nspace[2]) +
                sIteration_nspace[2]};

        const int index = n_index[0] + n_index[1] * B::sizeX +
                          n_index[2] * B::sizeX * B::sizeY;
          ...
          for (d[2] = s_dest[2]; d[2] < e_dest[2]; d[2]++)
            for (d[1] = s_dest[1]; d[1] < e_dest[1]; d[1]++)
              for (d[0] = s_dest[0]; d[0] < e_dest[0]; d[0]++) {
                ...
                if (fabs(w) > 0)
                  matDest.Access(d[0] - sEasy_bspace[0], d[1] - sEasy_bspace[1],
                                 d[2] - sEasy_bspace[2])++;
              }
        }
        ...
        for (d[0] = sEasy_bspace[0]; d[0] < eEasy_bspace[0]; d[0]++) {
          ...
          if (val > 0) {
            const int ghost_index =
                iGhostStart + d[0] - ghosts_start[0] +
          ...
          for (d[2] = s_dest[2]; d[2] < e_dest[2]; d[2]++)
            for (d[1] = s_dest[1]; d[1] < e_dest[1]; d[1]++)
              for (d[0] = s_dest[0]; d[0] < e_dest[0]; d[0]++) {
                ...
                if (fabs(w) > 0) {
                  int &destHit = matDest.Access(d[0] - sEasy_bspace[0],
                                                d[1] - sEasy_bspace[1],
                                                d[2] - sEasy_bspace[2]);
                  ...
                  iwp.point_index = matKey.Access(s[0] - sIteration_nspace[0],
                                                  s[1] - sIteration_nspace[1],
                                                  s[2] - sIteration_nspace[2]);
                  iwp.weights_index[0] =
                      B::shouldProcessDirectionX
                          ? iWStart + d[0] - s_bspace[0] - filter_support[0]
                          : 0;
                  iwp.weights_index[1] =
                      B::shouldProcessDirectionY
                          ? iWStart + d[1] - s_bspace[1] - filter_support[0]
                          : 0;
                  iwp.weights_index[2] =
                      B::shouldProcessDirectionZ
                          ? iWStart + d[2] - s_bspace[2] - filter_support[0]
                          : 0;
  ...
  allocator<Real>().deallocate(const_cast<Real *>(weights),
                               filter_support[1] - filter_support[0]);
}
...
void MRAG_BBInfoCreator<WaveletsType, BlockType>::_computeEasyGhosts_Analysis(
  ...
  // 4. if the range is non zero compute the weight of each point (it does not
  // change!)
  ...
  const int easy_bspace_start[3] = {
      B::shouldProcessDirectionX
          ? (int)ceil(pow(2.0, -level_difference) *
                          ((0 - filter_support[0]) + n.index[0] * B::sizeX) -
                      b.index[0] * B::sizeX)
          : 0,
      B::shouldProcessDirectionY
          ? (int)ceil(pow(2.0, -level_difference) *
                          ((0 - filter_support[0]) + n.index[1] * B::sizeY) -
                      b.index[1] * B::sizeY)
          : 0,
      B::shouldProcessDirectionZ
          ? (int)ceil(pow(2.0, -level_difference) *
                          ((0 - filter_support[0]) + n.index[2] * B::sizeZ) -
                      b.index[2] * B::sizeZ)
          : 0};

  const int easy_bspace_end[3] = {
      B::shouldProcessDirectionX ? (1 +
                                    (int)floor(pow(2.0, -level_difference) *
                                               ((B::sizeX - filter_support[1]) +
                                                n.index[0] * B::sizeX)) -
                                    b.index[0] * B::sizeX)
                                 : 1,
      B::shouldProcessDirectionY ? (1 +
                                    (int)floor(pow(2.0, -level_difference) *
                                               ((B::sizeY - filter_support[1]) +
                                                n.index[1] * B::sizeY)) -
                                    b.index[1] * B::sizeY)
                                 : 1,
      B::shouldProcessDirectionZ ? (1 +
                                    (int)floor(pow(2.0, -level_difference) *
                                               ((B::sizeZ - filter_support[1]) +
                                                n.index[2] * B::sizeZ)) -
                                    b.index[2] * B::sizeZ)
                                 : 1};
  ...
  const int easy_range_end[3] = {std::min(easy_bspace_end[0], ghosts_end[0]),
                                 std::min(easy_bspace_end[1], ghosts_end[1]),
                                 std::min(easy_bspace_end[2], ghosts_end[2])};

  nFoundEasyGhosts = std::max(0, (easy_range_end[0] - easy_range_start[0])) *
  ...
  // 3.
  {
    ...
    const int s[3] = {std::max(entire_bspace_start[0], ghosts_start[0]),
                      std::max(entire_bspace_start[1], ghosts_start[1]),
                      std::max(entire_bspace_start[2], ghosts_start[2])};

    const int e[3] = {std::min(entire_bspace_end[0], ghosts_end[0]),
    ...
    assert(nBastards + nFoundEasyGhosts ==
...

  {
    ...
    // A.
    const Real *weights = cookFilter<W, Real, true>(
    ...
    // C.
    {
      const int tmp_start[3] = {
          ((b.index[0] * B::sizeX + easy_range_start[0]) << level_difference) -
              n.index[0] * B::sizeX,
          ((b.index[1] * B::sizeY + easy_range_start[1]) << level_difference) -
              n.index[1] * B::sizeY,
          ((b.index[2] * B::sizeZ + easy_range_start[2]) << level_difference) -
              n.index[2] * B::sizeZ};

      const int tmp_end[3] = {((b.index[0] * B::sizeX + easy_range_end[0] - 1)
                               << level_difference) -
                                  n.index[0] * B::sizeX + 1,
                              ((b.index[1] * B::sizeY + easy_range_end[1] - 1)
                               << level_difference) -
                                  n.index[1] * B::sizeY + 1,
                              ((b.index[2] * B::sizeZ + easy_range_end[2] - 1)
                               << level_difference) -
                                  n.index[2] * B::sizeZ + 1};
      ...
      const int easy_nspace_end[3] = {
          B::shouldProcessDirectionX ? (-1 + tmp_end[0] + filter_support[1])
                                     : 1,
          B::shouldProcessDirectionY ? (-1 + tmp_end[1] + filter_support[1])
                                     : 1,
          B::shouldProcessDirectionZ ? (-1 + tmp_end[2] + filter_support[1])
                                     : 1};
        ...
        for (d[1] = easy_range_start[1]; d[1] < easy_range_end[1]; d[1]++)
          for (d[0] = easy_range_start[0]; d[0] < easy_range_end[0]; d[0]++) {
            const int d_nspace[3] = {
                ((b.index[0] * B::sizeX + d[0]) << level_difference) -
                    n.index[0] * B::sizeX,
                ((b.index[1] * B::sizeY + d[1]) << level_difference) -
                    n.index[1] * B::sizeY,
                ((b.index[2] * B::sizeZ + d[2]) << level_difference) -
                    n.index[2] * B::sizeZ};

            const int src_start[3] = {
                B::shouldProcessDirectionX ? (d_nspace[0] + filter_support[0])
                                           : 0,
                B::shouldProcessDirectionY ? (d_nspace[1] + filter_support[0])
                                           : 0,
                B::shouldProcessDirectionZ ? (d_nspace[2] + filter_support[0])
                                           : 0,
            };

            const int src_end[3] = {
                B::shouldProcessDirectionX ? (d_nspace[0] + filter_support[1])
                                           : 1,
                B::shouldProcessDirectionY ? (d_nspace[1] + filter_support[1])
                                           : 1,
                B::shouldProcessDirectionZ ? (d_nspace[2] + filter_support[1])
                                           : 1,
            };
            ...
            for (s[2] = src_start[2]; s[2] < src_end[2]; s[2]++)
              for (s[1] = src_start[1]; s[1] < src_end[1]; s[1]++)
                for (s[0] = src_start[0]; s[0] < src_end[0]; s[0]++) {
                  const double w =
                      (B::shouldProcessDirectionX
                           ? weights[s[0] - src_start[0] - filter_support[0]]
                           : 1) *
                      (B::shouldProcessDirectionY
                           ? weights[s[1] - src_start[1] - filter_support[0]]
                           : 1) *
                      (B::shouldProcessDirectionZ
                           ? weights[s[2] - src_start[2] - filter_support[0]]
                           : 1);
        ...
        for (int i = 0; i < nElements; i++)
          if (matNeeded.LinAccess(i) == 1) {
            const int n_index[3] = {
                ...
                (i / easy_size[0] / easy_size[1] % easy_size[2]) +
                    easy_nspace_start[2]};
              ...
              for (s[1] = src_start[1]; s[1] < src_end[1]; s[1]++)
                for (s[0] = src_start[0]; s[0] < src_end[0]; s[0]++) {
                  ...
                  if (w[0] * w[1] * w[2] > 0) {
                    ...
                    iwp.point_index =
                        matKey.Access(s[0] - easy_nspace_start[0],
                                      s[1] - easy_nspace_start[1],
                                      s[2] - easy_nspace_start[2]);

                    iwp.weights_index[0] =
                        B::shouldProcessDirectionX
                            ? (iStartW + s[0] - src_start[0] -
                               filter_support[0])
                            : 0;
                    iwp.weights_index[1] =
                        B::shouldProcessDirectionY
                            ? (iStartW + s[1] - src_start[1] -
                               filter_support[0])
                            : 0;
                    iwp.weights_index[2] =
                        B::shouldProcessDirectionZ
                            ? (iStartW + s[2] - src_start[2] -
                               filter_support[0])
                            : 0;
                    counter++;
                  }
...
template <typename WaveletsType, typename BlockType>
MRAG_BBInfoCreator<WaveletsType, BlockType>::MRAG_BBInfoCreator(
...
MRAG_BBInfoCreator<WaveletsType, BlockType>::createBoundaryInfoBlock(
  ...
  // 1.
  BoundaryInfoBlock *bbinfo = new BoundaryInfoBlock(block_size, b, neighbors);
  ...
  // 2.
  {
    ...
    for (int code = 0; code < 27; code++) {
      ...
      const int e[3] = {
          d[0] < 0 ? 0
                   : (d[0] == 0 ? B::sizeX : (B::sizeX + stencil_end[0] - 1)),
          d[1] < 0 ? 0
                   : (d[1] == 0 ? B::sizeY : (B::sizeY + stencil_end[1] - 1)),
          d[2] < 0 ? 0
                   : (d[2] == 0 ? B::sizeZ : (B::sizeZ + stencil_end[2] - 1))};
  ...
  for (set<int>::iterator itCode = coveredCodes.begin();
    ...
    const int s[3] = {d[0] < 0 ? stencil_start[0] : (d[0] == 0 ? 0 : B::sizeX),
                      d[1] < 0 ? stencil_start[1] : (d[1] == 0 ? 0 : B::sizeY),
                      d[2] < 0 ? stencil_start[2] : (d[2] == 0 ? 0 : B::sizeZ)};
  ...
  if (bastards.size() > 0) {
    SmartBlockFinder smartGuy(b, neighbors, stencil_start, stencil_end,
                              block_size);
...

  {
    ...
    IndexWP indexwp;
    if (powf(2, sizeof(pointindex.index) * 8 - 1) <
        B::sizeX * B::sizeY * B::sizeZ) {
      printf("OUCH: (1<<(sizeof(pointindex.index)*8-1) <  B::sizeX* B::sizeY* "
             "B::sizeZ)\n");
      printf("-> OUCH: %f < %d\n", powf(2, sizeof(pointindex.index) * 8 - 1),
             B::sizeX * B::sizeY * B::sizeZ);
      abort();
    }

    if (powf(2, sizeof(indexwp.weights_index[0]) * 8) <=
        bbinfo->weightsPool.size()) {
      printf("OUCH: (1<<(sizeof(indexwp.weights_index[0])*8) <= "
             "bbinfo->weightsPool.size()\n");
      printf("-> OUCH: %f < %d\n",
             powf(2, sizeof(indexwp.weights_index[0]) * 8),
             (int)bbinfo->weightsPool.size());
      abort();
    }
  }
...
void MRAG_BBInfoCreator<WaveletsType, BlockType>::_resolveBastardGhosts(
  ...
  // The ghost is not found: find the level where the ghost is lying. 5.
  // if ghost.level < b.level generate synthesis ghosts otherwise analysis
  // (abort if lying level = block level) 6.		put the generated ghosts
  // in the new front if they not exist already 7.	swap the old front with
  // the new front, goto 2. 8.	collect the shit 9.	free the shit

  // 1.
  typedef _MRAG_GHOSTSCREATION_ALLOCATOR<BastardGhost *> ABG;
  typedef vector<BastardGhost *, ABG> GhostVector;
  typedef _MRAG_GHOSTSCREATION_ALLOCATOR<std::pair<const I3, BastardGhost *>>
      ABGMap;
  ...
  typedef set<double, std::less<double>, _MRAG_GHOSTSCREATION_ALLOCATOR<double>>
      WeightSet;
  typedef map<double, int, std::less<double>,
              _MRAG_GHOSTSCREATION_ALLOCATOR<std::pair<const double, int>>>
      WeightToIndexMap;
  ...
  while (oldFront.size() > 0) {
    ...
    while (oldFront.size() > 0) {
      ...
      PointIndex *pti =
          smartFinder.findData(bastard->block_level, bastard->index, &node);
      ...
      if (pti != NULL) {
        ...
        bastard->generateRequests(smartFinder, buffer, newFront, start_level,
                                  node->level);
    }
  ...
  for (int l = 0; l < buffer.size(); l++) {
    GhostMap &m = buffer[l];
    for (typename GhostMap::const_iterator it = m.begin(); it != m.end();
         it++) {
      if (it->second->status != BastardGhost::BastardGhost_ResolvedKnown) {
        printf("ERROR!! (level %d) key: %d %d %d value: ghost level %d index "
               "%d %d %d\n",
               l, it->first.i[0], it->first.i[1], it->first.i[2], l,
               it->second->index.i[0], it->second->index.i[1],
               it->second->index.i[2]);
        if (it->second->status != BastardGhost::BastardGhost_Unresolved)
          printf("no pending requests!! status: %d\n", it->second->status);
        bAbort = true;
      }
    }
  }
  if (bAbort) {
    printf("Aborting in MRAG_BBInfoCreator<WaveletsType, "
           "BlockType>::_resolveBastardGhosts/\n");
    printf("const GridNode& b = (index=%d %d %d, level = %d)\n", b.index[0],
           b.index[1], b.index[2], b.level);
    printf("Neighbors are: \n");
    for (int i = 0; i < neighbors.size(); i++)
      printf("neighbor %d: (index=%d %d %d, level = %d)\n", i,
             neighbors[i]->index[0], neighbors[i]->index[1],
             neighbors[i]->index[2], neighbors[i]->level);
  ...
  for (int iPass = 0; iPass < 2; iPass++) {
    for (int i = 0; i < bastards.size(); i++) {
      ...
      const int ghost_index[3] = {ghost->index.i[0], ghost->index.i[1],
                                  ghost->index.i[2]};

      const int d[3] = {(int)floor(ghost_index[0] / (double)block_size[0]),
      ...
      const int rel_pos[3] = {ghost_index[0] - s[0], ghost_index[1] - s[1],
                              ghost_index[2] - s[2]};
      const int index = bb.boundary[code].start + rel_pos[0] +
                        rel_pos[1] * size_chunk[0] +
                        rel_pos[2] * size_chunk[0] * size_chunk[1];

      assert(index - bb.boundary[code].start < bb.boundary[code].nGhosts);

      if (iPass == 0)
        ghost->template collect<0>(wSet, mapW2I, bb.ghosts[index], weightsPool,
                                   1, 1, 1, false);
      else
        ghost->template collect<1>(wSet, mapW2I, bb.ghosts[index], weightsPool,
                                   1, 1, 1, false);
    }
  ...
  // 9.
  for (typename GhostBuffer::iterator itV = buffer.begin(); itV != buffer.end();
       itV++) {
    for (typename GhostMap::iterator itM = itV->begin(); itM != itV->end();
         itM++) {
...
inline const Real *cookFilter(const int level_difference,
  ...
  for (i = sH; i < eH; i++)
    H[i] = bAnalysisFilter ? W::getHa(i) : W::getHs(i);
  for (i = start; i < end; i++)
    weights[i] = 0.0;
  for (i = sH; i < eH; i++)
    weights[-i] = H[i];
