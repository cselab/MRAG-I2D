...
const Real Wavelets_Interp4thOrder::Ga[7] = {1 / 16.,  0, -9 / 16., 1,
                                             -9 / 16., 0, 1 / 16.};
const Real Wavelets_Interp4thOrder::Hs[7] = {-1 / 16., 0, 9 / 16., 1,
                                             9 / 16.,  0, -1 / 16.};
...
const Real Wavelets_AverageInterp3rdOrder::Hs[6] = {-1 / 8., 1 / 8., 1,
                                                    1,       1 / 8., -1 / 8.};
const Real Wavelets_AverageInterp3rdOrder::Ga[6] = {
...
const Real Wavelets_AverageInterp5thOrder::Hs[10] = {
    3 / 128., -3 / 128., -11. / 64., 11. / 64., 1,
    1,        11 / 64.,  -11. / 64., -3 / 128., 3 / 128.};
const Real Wavelets_AverageInterp5thOrder::Ga[10] = {
    3 / 256., 3 / 256.,  -11 / 128., -11 / 128., 1 / 2.,
