...
public:
  // Note for programmers: functor is used in the end as ProcessingMT type in
  // BlockProcessingMT_Simple...
  /**
   * Copy constructor (may not be needed as compiler-generated one may be
   * enough).
   */
  ...
  /**
   * Default constructor (may not be needed as compiler-generated one may be
   * enough).
   */
...
public:
   ...
   * @param i     Reference to extended block (including ghosts as in
   * MRAG::BlockLab) to be used as input.
   * @param info  Reference to info of current block.
