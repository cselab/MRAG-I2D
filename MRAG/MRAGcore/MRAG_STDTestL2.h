...
class MRAG_STDTestL2 // LEVEL 2: correct data representation, correct
                     // data-processing
{
protected:
  ...
  MRAG_STDTestL2()
      : grid(4, 4), refiner(), compressor(), lab(), blockfwt(), viewer() {
  ...
  void _some_fwt() {
    ...
    BlockFWT<Wavelets, Block>::template multichannel_fwt<0, 0>(
        grid.getBlocksInfo(), grid.getBlockCollection(),
