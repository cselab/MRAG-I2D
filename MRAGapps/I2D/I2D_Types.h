...
struct VelocityBlock {
  ...
  void clear() { memset(u, 0, sizeof(Real) * _BLOCKSIZE_ * _BLOCKSIZE_ * 2); }

  static VelocityBlock *allocate(const int nitems) {
    VelocityBlock *ptr =
        (VelocityBlock *)_mm_malloc(sizeof(VelocityBlock) * nitems, 16);
...
struct FluidElement2D {
  ...
  Real time_rec(Real t) { return omega + t * tmp; }
...
//===================================================
struct FluidBlock2D
    : public Block<FluidElement2D, _BLOCKSIZE_, _BLOCKSIZE_, 1> {
  Real external_data[_BLOCKSIZE_][_BLOCKSIZE_];

  typedef FluidElement2D ElementType;

  FluidBlock2D(ElementType e = ElementType())
      : Block<FluidElement2D, _BLOCKSIZE_, _BLOCKSIZE_, 1>(e) {}

  void serialize(FILE *outputBinary) {
    fwrite(reinterpret_cast<char *>(this), sizeof(FluidBlock2D), 1,
           outputBinary);
  }
...
struct Streamer_OmegaLTS {
  inline static Real operate(FluidElement2D &input, Real time) {
    return input.time_rec(time);
  }
};
...
struct Streamer_Velocity {
  ...
  inline static void operate(FluidElement2D &input, Real time,
...
template <>
inline void Streamer_Velocity::operate<2>(FluidElement2D &input, Real time,
                                          Real output[2]) {
  output[0] = input.u[0];
  output[1] = input.u[1];
}
...
//		RK2
//===================================================
template <int stage> struct UpdateScalarRK2 {
  Real t, dt;
...
template <int stage> struct UpdateScalarRK2_Simple {
  Real dt;
...
template <>
inline Real
velocity_projector_impl<FluidElement2D, 0>(const FluidElement2D &t) {
  return t.u[0];
}
template <>
inline Real
velocity_projector_impl<FluidElement2D, 1>(const FluidElement2D &t) {
  return t.u[1];
}
make_projector(velocity_projector, velocity_projector_impl)

    template <typename T, int i>
    inline Real vorticity_projector_impl(const T &t);
template <>
inline Real
vorticity_projector_impl<FluidElement2D, 0>(const FluidElement2D &t) {
  return t.omega;
}
make_projector(vorticity_projector, vorticity_projector_impl)

    template <typename T, int i>
    inline Real vorticityANDvelocityANDchi_projector_impl(const T &t);
template <>
inline Real vorticityANDvelocityANDchi_projector_impl<FluidElement2D, 0>(
    const FluidElement2D &t) {
  return t.omega;
}
template <>
inline Real vorticityANDvelocityANDchi_projector_impl<FluidElement2D, 1>(
    const FluidElement2D &t) {
  return t.u[0];
}
template <>
inline Real vorticityANDvelocityANDchi_projector_impl<FluidElement2D, 2>(
    const FluidElement2D &t) {
  return t.u[1];
}
template <>
inline Real vorticityANDvelocityANDchi_projector_impl<FluidElement2D, 3>(
    const FluidElement2D &t) {
  return t.tmp;
}
make_projector(vorticityANDvelocityANDchi_projector,
               vorticityANDvelocityANDchi_projector_impl)

    template <typename T, int i>
    inline Real vorticityANDvelocity_projector_impl(const T &t);
template <>
inline Real vorticityANDvelocity_projector_impl<FluidElement2D, 0>(
    const FluidElement2D &t) {
  return t.omega;
}
template <>
inline Real vorticityANDvelocity_projector_impl<FluidElement2D, 1>(
    const FluidElement2D &t) {
  return t.u[0];
}
template <>
inline Real vorticityANDvelocity_projector_impl<FluidElement2D, 2>(
    const FluidElement2D &t) {
  return t.u[1];
}
make_projector(vorticityANDvelocity_projector,
               vorticityANDvelocity_projector_impl)

    template <typename T, int i>
    inline Real obstacle_projector_impl(const T &t);
template <>
inline Real
obstacle_projector_impl<FluidElement2D, 0>(const FluidElement2D &t) {
  return t.tmp;
}
