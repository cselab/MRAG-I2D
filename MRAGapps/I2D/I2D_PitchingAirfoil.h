...
private:
  ...
  const Real D_char, l; // D_char: characteristic length, l: x-offset rotation
                        // center from leading edge
  const Real xcrot0, ycrot0; // time invariant part of rotation center

public:
  I2D_PitchingAirfoil(Grid<W, B> &grid, ArgumentParser &parser, const Real _xm,
                      const Real _ym, const Real _D, const Real _l,
                      ...
                      const Real _pitchPeriod, const Real _pitchPhase,
