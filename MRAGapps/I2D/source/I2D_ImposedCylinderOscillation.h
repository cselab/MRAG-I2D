...
public:
  I2D_ImposedCylinderOscillation(ArgumentParser &parser, Grid<W, B> &grid,
                                 const Real _xm, const Real _ym, const Real _A,
                                 const Real _T, const string _direction,
                                 const Real _D, const Real eps,
                                 const Real Uinf[2],
