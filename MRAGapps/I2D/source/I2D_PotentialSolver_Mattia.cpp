...
struct GetTmp {
  static inline Real stream(FluidElement2D &out) { return out.tmp; }
};
...
void I2D_PotentialSolver_Mattia::_count_sourceparticles() {
  ...
  ThresholdParticles<GetTmp, 0> countparticles(tolParticle, scaling_factor,
                                               blockid2info);
...
void I2D_PotentialSolver_Mattia::_collect_sourceparticles() {
  ...
  ThresholdParticles<GetTmp, 1> collectparticles(tolParticle, scaling_factor,
                                                 blockid2info);
