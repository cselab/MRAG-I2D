...
public:
  ...
  public:
    double angle, xm, ym, D, angular_velocity, vx, vy, m, J, rho, vdefx, vdefy,
        Uinf[2];
  ...
  I2D_FloatingCylinder(ArgumentParser &parser, Grid<W, B> &grid, const Real _xm,
                       const Real _ym, const Real D, const Real eps,
                       const Real Uinf[2],
