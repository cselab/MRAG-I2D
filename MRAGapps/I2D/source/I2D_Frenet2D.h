...
public:
  ...
  // Methods
  void solve(const double ds, const double *k, double *rX, double *rY,
             double *tanX, double *tanY, double *norX, double *norY,
  ...
  void solveVelProfile(const double ds, const double *kt, const double *kt_dt,
                       const double *tanX, const double *tanY,
                       const double *norX, const double *norY, double *vX,
                       double *vY, double *vTanX, double *vTanY, double *vNorX,
