...
{
public:
	PF_DipoleEight(MRAG::ArgumentParser & parser, const Real _D, const Real _V, const Real _acc, const Real _radius, const complex<Real> _locationCenter, const Real _dir[2], const Real lr, const Real greedyEps, bool isSmooth, bool isControlled, const Real T = 0, const int _ID = 0, RL::RL_TabularPolicy **_policy = NULL, const int seed = 0);
