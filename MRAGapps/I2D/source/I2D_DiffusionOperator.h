...
public:
  I2D_DiffusionOperator(Grid<W, B> &grid, double viscosity, double FC)
      : grid(grid), viscosity(viscosity), FC(FC), DIM(2.0) {
...
public:
  I2D_DiffusionOperator_4thOrder(Grid<W, B> &grid, double viscosity, double FC)
      : I2D_DiffusionOperator(grid, viscosity, FC) {}
