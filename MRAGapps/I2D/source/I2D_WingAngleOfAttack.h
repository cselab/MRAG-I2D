...
class I2D_WingAngleOfAttack: public I2D_ObstacleOperator
{
...
public:
	...
	I2D_WingAngleOfAttack(Grid<W,B>& grid, const Real length, const Real width, const Real position[2], vector<Real> anglesIn, const Real epsilon): 
