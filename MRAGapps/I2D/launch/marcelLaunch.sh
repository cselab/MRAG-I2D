...
SETTINGS+=" -uinfy 0.00"	# freestream velocity in y
...
SETTINGS+=" -useoptimizer 1" # true: fitness function for CMA-ES is calculated, false: fitness function not calculated, fluid mediated interactions only --> other studies: set to 0
