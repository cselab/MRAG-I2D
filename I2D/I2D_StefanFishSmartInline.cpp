...
I2D_StefanFishSmartInline::I2D_StefanFishSmartInline(
    ...
    : I2D_StefanFishSmart(parser, grid, _xm, _ym, D, T, tau, angle, eps, Uinf,
...
bool I2D_StefanFishSmartInline::mapState(
    vector<int> &state,
...
void I2D_StefanFishSmartInline::reward(
    const double t,
    map<string, vector<I2D_FloatingObstacleOperator *>> *_data) {
  assert(shape != NULL);
...
void I2D_StefanFishSmartInline::update(
