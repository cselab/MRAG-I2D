...
SETTINGS=
SETTINGS+=" -study ROTATING_CYLINDER_PAIR"
SETTINGS+=" -bpd 32"
...
SETTINGS+=" -rio free_frame" # remember ive also changed bpd from 32 to 4
#SETTINGS+=" -rio rigid_frame"

SETTINGS+=" -ramp 100"
SETTINGS+=" -adaptfreq 50"
SETTINGS+=" -dumpfreq 2"
SETTINGS+=" -savefreq 250"

SETTINGS+=" -obstacle rotcyl"
SETTINGS+=" -burgersfactor 0.7"
