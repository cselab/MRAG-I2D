...
RL_ObjectFactory::RL_ObjectFactory(const Real charLength, const Real XCM,
                                   const Real YCM)
    : charLength(charLength), XCM(XCM), YCM(YCM) {}
...
void RL_ObjectFactory::create(MRAG::ArgumentParser &parser,
  ...
  for (int i = 0; i < N; i++) {
    ...
    if( name == "RL_CircularWall" )
    {
            ...
            map< string, vector<RL_Agent *> >::iterator it =
    shapesMap.find(name);
    ...
    else if( name == "RL_SmartyCircle" )
    {
            ...
            RL_SmartyCircle * object = new RL_SmartyCircle(parser, xm, ym, d,
    counterID, policy, rand());
    ...
    */
    ...
    else if( name == "RL_SmartyInline" )
    {
            ...
            RL_SmartyInline * object = new RL_SmartyInline(parser, xm, ym, d,
    dir, counterID, policy, rand());
    ...
    */
    ...
    else if( name == "RL_SmartyLattice" )
    {
            ...
            RL_SmartyLattice * object = new RL_SmartyLattice(parser, xm, ym, d,
    dir, counterID, policy, rand());
    ...
    else if( name == "RL_SmartyLattices" )
    {
            ...
            for(int ix=0; ix<side; ix++)
                    for(int iy=0; iy<side; iy++)
                    {
                            ...
                            RL_SmartyLattice * object = new
    RL_SmartyLattice(parser, xm, ym, d, dir, counterID, policy, rand());
    ...
    */
    ...
    else if( name == "RL_SmartyDodger" )
    {
            ...
            RL_SmartyDodger * object = new RL_SmartyDodger(parser, xm, ym, d, T,
    counterID, policy, rand());
    ...
    else if( name == "RL_SmartyDodgers" )
    {
            ...
            for(int j=0; j<number; j++)
            {
                    ...
                    RL_SmartyDodger * object = new RL_SmartyDodger(parser,
    xx+0.5, yy+0.5, d, T, counterID, policy, rand());
    ...
    else if( name == "RL_Columns" )
    {
            ...
            for(int j=0; j<number; j++)
            {
                    ...
                    const Real xx = radius*cos(angle);
                    const Real yy = radius*sin(angle);
                    //RL_Column * object = new RL_Column(parser, xx+0.5, yy+0.5,
    d, counterID); RL_Column * object = new RL_Column(parser, rng.uniform(0,1),
    rng.uniform(0,1), d, counterID);
    ...
    */
    ...
    else if( name == "RL_DynamicColumn" )
    {
            ...
            RL_DynamicColumn * object = new RL_DynamicColumn(parser, xm, ym, d,
    counterID);
    ...
    else if( name == "RL_DynamicColumns" )
    {
            ...
            for(int j=0; j<number; j++)
            {
                    ...
                    const Real xx = radius*cos(angle);
                    const Real yy = radius*sin(angle);
                    RL_DynamicColumn * object = new RL_DynamicColumn(parser,
    rng.uniform(0,1), rng.uniform(0,1), d, counterID);
    ...
    if (name == "RL_Food") {
      ...
      for (int j = 0; j < number; j++) {
        ...
        RL_Food *object =
            new RL_Food(parser, xx + 0.5, yy + 0.5, d, counterID, rand());
      ...
      RL_SmartyGlutton *object = new RL_SmartyGlutton(
          parser, xm, ym, d, T, nactions, cutoffGluttons, cutoffFood, steer,
          noise, selfavoid, NN, counterID, policy, rand());
      ...
      for (int ix = 0; ix < sidemore; ix++)
        for (int iy = 0; iy < sidemore; iy++) {
          if (countside < number) {
            ...
            const Real xx =
                ix * spacing + spacing / 2.0 + rng.uniform(0.0, spacing / 2.0);
            const Real yy =
                iy * spacing + spacing / 2.0 + rng.uniform(0.0, spacing / 2.0);

            RL_SmartyGlutton *object = new RL_SmartyGlutton(
                parser, xx, yy, d, T, nactions, cutoffGluttons, cutoffFood,
                steer, noise, selfavoid, NN, counterID, policy, rand());
